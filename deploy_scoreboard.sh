...
LOCAL_FILE="O:\\Descargas\\hackaton\\refresh_assets\\scoreboard.html"

echo "==> Uploading modified scoreboard.html to remote host..."
scp -i "$SSH_KEY" -o StrictHostKeyChecking=no "$LOCAL_FILE" "${REMOTE_USER}@${REMOTE_HOST}:/tmp/scoreboard_fixed.html"
...
echo "==> Deploy complete. Refresh https://45.55.49.111/scoreboard to verify."
